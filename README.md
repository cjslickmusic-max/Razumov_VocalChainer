...
- **`Artifacts/Razumov VocalChainer.vst3`**
...
- **VST3:** `build/RazumovVocalChain_artefacts/Release/VST3/Razumov VocalChainer.vst3`
- **AU:** `build/RazumovVocalChain_artefacts/Release/AU/Razumov VocalChainer.component`
- **Standalone:** `build/RazumovVocalChain_artefacts/Release/Standalone/Razumov VocalChainer.app`

Если **`lib..._SharedCode.a` свежее, а `Razumov VocalChainer.vst3` со старой датой** — инкрементальная сборка не перелинковала бандл. Сделайте полную пересборку цели:  
